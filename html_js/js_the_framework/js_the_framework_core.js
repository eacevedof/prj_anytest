...
var TfwCore =
{
    ...
    is_null: function (oAnyObject)
    {
        return (oAnyObject == null);
    },

    //Indica si existe una propiedad en el objeto
    //oAnyProperty = oAnyObject.oProperty
    is_undefined: function(oAnyProperty)
    {
        return (oAnyProperty==undefined);
    },
    ...
    {
        //this.show_in_console('oAnyObject is_array :');
        //this.show_in_console(oAnyObject.length);
