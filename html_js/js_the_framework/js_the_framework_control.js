...
var TfwControl =
{
    ...
    //object
    get_text_by_id: function(sTextId)
    {
    ...
    get_text_value_by_id: function(sTextId)
    {
        ...
        var eText = this.get_text_by_id(sTextId);
    ...
    select_searched_value: function(sSelectId, sValue)
    {
    ...
    is_textarea_element: function(oAnyElement)
    {
    ...
    is_input_element_by_id : function (sElementId)
    {
        ...
        return this.oCore.is_input_element(eTemp);
    },
    
    //boolean input-text
    is_text: function(eElement)
    {
        if(this.oCore.is_input_element(eElement))
        {
    ...
    is_text_by_id: function(sElementId)
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_text(eTemp);
    },
    
    //boolean input-text
    is_hidden: function(eElement)
    {
        if(this.oCore.is_input_element(eElement))
        {
    ...
    is_hidden_by_id: function(sElementId)
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_hidden(eTemp);
    },
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_file(eTemp);
    },    

    is_textarea: function(eElement)
    {
        if(this.oCore.is_textarea_element(eElement))
        {
            return true;
        }
    ...
    is_textarea_by_id: function(sElementId)
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_textarea(eTemp);
    },
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_radio(eTemp);
    },
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_select(eTemp);
    },

    is_select_one : function(eElement)
    {
        if(this.oCore.is_select(eElement))
        {
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_select_one(eTemp);
    },
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_select_multiple(eTemp);
    },
    ...
    //Check o radio
    is_unchecked: function(eElement)
    {
        return !this.is_checked(eElement);
    },
    //boolean
    ...
    {
        var eTemp = document.getElementById(sElementId);
        return this.oCore.is_checkbox(eTemp);
    },
    ...
    get_checked_values: function(sElementName, IsChecked)
    {
        ...
        {
            this.core.show_in_console('Error getting checked values from '+sElementName+'. No es un array');
        }
        return arValues;
     },
    ...
    conmute_on_off: function(sMultiName)
    {
