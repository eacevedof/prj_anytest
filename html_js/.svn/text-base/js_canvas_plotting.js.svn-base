 ...
 * @uses 
 * @notes Añadida opción en constructor para detectar eventos de raton y mano. Carlos GonzaleZ
 * @date 17-01-2012 16:34 (spain)
 */
...
//Se a�ade el metodo contains a los objetos string
